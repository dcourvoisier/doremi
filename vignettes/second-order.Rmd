...
### Example 2 - Using an initial condition in a time different from t0=0
...
```{r}
time <- 0:99
data2 <- generate.2order(time = time,
                               excitation = as.numeric(time>20),
                               y0 = 0,
                               v0 = 0,
                               t0 = 0,
...
```{r}
data2_t0_43 <- generate.2order(time = time,
                               excitation = as.numeric(time>20),
                               y0 = 1.077549,
                               v0 = -1.311226e-01,
                               t0 = 43,
...
ggplot2::ggplot() + 
  ggplot2::geom_line(data=data2,ggplot2::aes(t,y,color="Solution with t0=0")) +
  ggplot2::geom_point(data=data2_t0_43,ggplot2::aes(t,y,color="Solution with t0=43"))
```
...
### Example 3 - studying the effect of periodical excitations

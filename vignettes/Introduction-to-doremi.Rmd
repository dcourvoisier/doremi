...
ggplot2::ggplot( data = data.frame(mydatab2)) +
  ...
  ggplot2::geom_line(ggplot2::aes(timecol,excitation,colour = "Total excitation"))+
  ggplot2::facet_wrap(~id)+
  ggplot2::labs(x = "Time (s)",
           y = "Signal (arb. unit)",
           colour = "")
...
mydatab4 <- data.frame(timecol = timt1,
                 excitation = et1, 
                 signalcol = y1)
```
...
mydatab5rd <- mydatab5rd[order(id,timecol)]
...
ggplot2::ggplot( data = mydatab5$fulldata ) +
  ggplot2::geom_point(ggplot2::aes(timecol,dampedsignalraw, colour = "Full data set. No noise"))+
  ggplot2::geom_line(ggplot2::aes(timecol,excitation,colour = "Excitation"))+

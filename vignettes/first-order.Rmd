...
```{r fig.width = 7, fig.height = 16, fig.align = "center"}
...
#Input data
#Taking et1, et2, y1 and y2 from a previous example

#Analysis 
resd1 <- analyze.1order(data = data6,
                        input = "exc",
                        time = "t",
                        signal = "signalcol",
                        dermethod = "glla",
...
datad1n <- data6
datad1n$exc <- as.numeric(data6$t>50 & data6$t<60)
...
ggplot2::geom_point(ggplot2::aes(t, signalcol_estimated,colour = "predicted signalcol")) +
ggplot2::geom_point(ggplot2::aes(t, signalcol,colour = "signalcol")) +
ggplot2::geom_line(data= data6, ggplot2::aes(t, exc,colour = "Original excitation")) + 
ggplot2::geom_line(data= datad1n, ggplot2::aes(t, exc,colour = "New excitation"))  

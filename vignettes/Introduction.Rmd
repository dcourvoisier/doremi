...
signal<- generate.1order(time = time,
                         ...
                         k = 1,
                         yeq = 0)
signal<-cbind(as.data.table(signal),exc)
...
* Excitation coefficient: $\k_{j} = \frac{b_{2} + u_{2j}}{\gamma_{j}}$
...
$$\frac{d^2y}{dt} + 2\xi\omega_{n}\frac{dy}{dt} + \omega_{n}^2 y = k*U(t)  (3)$$

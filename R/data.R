...
#'   \item{timecol}{positive real number, time since the beginning of the test, in seconds (s)}
...
#'   \item{numtrials}{positive integer, number of trial to which the mean response time belongs}
